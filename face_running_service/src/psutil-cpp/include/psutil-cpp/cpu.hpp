...
// Operator overload for vector of scputimes structs, prints in python
// namedtuple style
std::ostream& operator<<(std::ostream& output,
                         const std::vector<scputimes>& cputimes);

// Operator overload for vector of scpufreq structs, prints in python namedtuple
// stylem
std::ostream& operator<<(std::ostream& output,
                         const std::vector<scpufreq>& cpufreq);
