...
"")
        icon4 = QtGui.QIcon()
        icon4.addPixmap(QtGui.QPixmap("/home/haobk/Desktop/Mydata/FaceService/face_client/ui/icons/custom/run_icon.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
...
"")
        ...
        self.bn_register_folder = QtWidgets.QPushButton(self.frame_10)
        self.bn_register_folder.setMaximumSize(QtCore.QSize(150, 16777215))
        self.bn_register_folder.setObjectName("bn_register_folder")
        self.horizontalLayout_22.addWidget(self.bn_register_folder)
        ...
        self.frame_image_5.setMinimumSize(QtCore.QSize(330, 320))
        self.frame_image_5.setMaximumSize(QtCore.QSize(330, 320))
        ...
        self.bn_remove_all_user = QtWidgets.QPushButton(self.frame_16)
        self.bn_remove_all_user.setObjectName("bn_remove_all_user")
        self.horizontalLayout_35.addWidget(self.bn_remove_all_user, 0, QtCore.Qt.AlignLeft)
        self.bn_remove_user = QtWidgets.QPushButton(self.frame_16)
        self.bn_remove_user.setObjectName("bn_remove_user")
        self.horizontalLayout_35.addWidget(self.bn_remove_user, 0, QtCore.Qt.AlignRight)
...
"")
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.bn_register_folder.setText(_translate("MainWindow", "Đăng kí từ thư mục"))
        ...
        self.bn_remove_all_user.setText(_translate("MainWindow", "Xóa toàn bộ"))
